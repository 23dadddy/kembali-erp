      ...
      <div className="flex h-[calc(100vh-64px)] overflow-hidden">
        ...
        <div className="w-56 bg-slate-50 border-r flex flex-col flex-shrink-0 overflow-y-auto">
          <div className="p-3">
            ...
            >
              <Plus className="w-4 h-4" /> {t('docs_upload')}
            </button>
          ...
          {showForm && (
            <div className="border-b bg-slate-50 p-4">
              <div className="max-w-xl space-y-3">
                <h3 className="font-semibold text-slate-800 text-sm">{t('docs_upload')}</h3>
                ...
                <div className="flex gap-2">
                  <button onClick={handleUpload} disabled={uploading || !form.title}
                    ...
                    {uploading ? t('loading') : t('docs_upload')}
                  </button>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="font-medium text-slate-400">{t('docs_no_docs')}</p>
                    ...
                    <div className="flex items-center gap-2 mt-3 pt-3 border-t border-slate-100 opacity-0 group-hover:opacity-100 transition-opacity">
                      {doc.file_url && (
                        <a href={doc.file_url} target="_blank" rel="noopener noreferrer"
                          ...
                          <Download className="w-3.5 h-3.5" /> {t('docs_download')}
                        </a>
                      )}
